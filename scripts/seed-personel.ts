 ...
 * işten ayrılanlar listeden çıkarıldı.
 *
...
const VERI: Record<string, Kisi[]> = {
  demetevler: [
    ...
    { ad: 'MELEK ÖZDEMİR', rol: 'tezgahtar', telefon: '545 201 86 84', tcKimlik: '19012933176', iseGiris: '2025-09-22' },
    { ad: 'ZARİFE ŞEVVAL DAĞ', rol: 'tezgahtar', telefon: '5344534920', iban: 'TR 6500 0100 9010 55087290 5001', tcKimlik: '12208273544', iseGiris: '2026-02-01' },
  ...
  bahcelievler: [
    ...
    { ad: 'FURKAN AKTAŞ', rol: 'tezgahtar', telefon: '538 652 13 18', iban: 'TR98 0006 7010 0000 0027 0480 45', tcKimlik: '12850251532', iseGiris: '2025-06-18' },
    { ad: 'AYŞEGÜL KAYĞUSUZ', rol: 'tezgahtar', telefon: '533 191 5298', iban: 'TR51 0004 6013 2588 8000 0291 96', tcKimlik: '37868187086', iseGiris: '2025-01-29' },
  ...
  etlik: [
    ...
    { ad: 'HATİCE KAYA', rol: 'tezgahtar', telefon: '551 363 9302', iban: 'TR96 0006 2000 7740 0006 8699 01', tcKimlik: '10780259338', iseGiris: '2023-05-29' },
    { ad: 'MUSTAFA SÖKMEN', rol: 'tezgahtar', telefon: '538 487 8316', tcKimlik: '45049209946' },
  ],
  batikent: [
    { ad: 'CESUR GÜLER', rol: 'usta', telefon: '541 589 8357', iban: 'TR68 0004 6005 2288 8000 120159', tcKimlik: '36181962264', iseGiris: '2024-10-02' },
    ...
    { ad: 'NEZİRE ÜNVER (İNCİ)', rol: 'tezgahtar', telefon: '546 767 0735', iban: 'TR97 0001 0012 2595 3918 2450 02', tcKimlik: '62779239050', iseGiris: '2025-12-08' },
